...
class fav_d extends StatefulWidget {
  @override
  _fav_dState createState() => _fav_dState();
}

class _fav_dState extends State<fav_d> {
  @override
  String email;
  ...
  void pressing(Driver) async
  {
    ...
    Dio dio=new Dio();
    try{
      response=await dio.put('https://f1-appstudent.herokuapp.com/favorite/driver',data: {"Email":email,"Driver":driver});
    }on DioError catch(e){
      error=true;
      if(e != null) {
